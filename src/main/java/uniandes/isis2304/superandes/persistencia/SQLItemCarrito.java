...
class SQLItemCarrito 
{
	 ...
	 */
	public long adicionarItemCarrito (PersistenceManager pm, long id, long idCarrito, String idProducto, int cantidad) 
	{
        Query q = pm.newQuery(SQL, "INSERT INTO " + ps.darTablaFactura() + "(id, idCarrito, idProducto, cantidad) values (?, ?, ?, ?)");
	 ...
	 */
	public Factura darItemCarritoPorId (PersistenceManager pm, long id) 
	{
